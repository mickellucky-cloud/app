...
export const ForgotPasswordScreen: React.FC<ForgotPasswordScreenProps> = ({
  ...
  return (
    <div id="forgot-password-screen" className="min-h-screen max-w-md mx-auto px-6 py-6 flex flex-col justify-between text-slate-900 dark:text-slate-100 animate-fadeIn transition-colors">
      <div>
        {/* Header Bar */}
        ...
        {!isVerified ? (
          <>
            ...
            <div className="mb-6">
              <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-purple-100 dark:bg-purple-500/10 border border-purple-200 dark:border-purple-500/20 text-purple-700 dark:text-purple-300 text-xs font-semibold mb-3">
              ...
              {authMethod === 'email' ? (
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <div className="flex items-center gap-1 px-3 py-3 rounded-xl bg-slate-50 dark:bg-[#0F1322] border border-slate-300 dark:border-white/10 text-slate-900 dark:text-white text-sm">
          ...
          <>
            ...
            {isSuccess ? (
              <div className="p-6 rounded-2xl bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-300 dark:border-emerald-500/40 text-center animate-fadeIn">
                <CheckCircle2 className="w-12 h-12 text-emerald-500 dark:text-emerald-400 mx-auto mb-3" />
                <h3 className="font-bold text-base text-slate-900 dark:text-white mb-1">Password Reset Successfully</h3>
