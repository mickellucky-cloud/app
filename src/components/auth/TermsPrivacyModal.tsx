...
export const TermsPrivacyModal: React.FC<TermsPrivacyModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/70 dark:bg-black/80 backdrop-blur-sm flex items-end sm:items-center justify-center p-0 sm:p-4 animate-fadeIn">
      <div className="w-full max-w-lg bg-white dark:bg-[#0F1320] border-t sm:border border-slate-200 dark:border-white/10 rounded-t-3xl sm:rounded-3xl p-6 text-slate-900 dark:text-slate-100 max-h-[85vh] flex flex-col shadow-2xl transition-colors">
        ...
        {/* Tab switch */}
        <div className="flex rounded-xl bg-slate-100 dark:bg-[#090C16] p-1 border border-slate-200 dark:border-white/[0.06] mb-4">
          <button
            onClick={() => setTab('terms')}
            className={`flex-1 py-1.5 rounded-lg text-xs font-semibold flex items-center justify-center gap-1.5 transition-all ${
              tab === 'terms'
                ? 'bg-white dark:bg-purple-600/30 text-purple-700 dark:text-purple-200 border border-purple-200 dark:border-purple-500/40 shadow-sm'
        ...
        {/* Scrollable Content */}
        <div className="flex-1 overflow-y-auto space-y-4 text-xs text-slate-600 dark:text-slate-300 pr-1 leading-relaxed">
          {tab === 'terms' ? (
            <>
              <section className="p-3.5 rounded-xl bg-slate-50 dark:bg-white/[0.02] border border-slate-200 dark:border-white/[0.04]">
                <h4 className="font-bold text-sm text-slate-900 dark:text-white mb-1.5">1. Acceptance of Terms</h4>
                <p>
              ...
              <section className="p-3.5 rounded-xl bg-slate-50 dark:bg-white/[0.02] border border-slate-200 dark:border-white/[0.04]">
                <h4 className="font-bold text-sm text-slate-900 dark:text-white mb-1.5">2. Eligibility & Verification</h4>
                <p>
              ...
              <section className="p-3.5 rounded-xl bg-slate-50 dark:bg-white/[0.02] border border-slate-200 dark:border-white/[0.04]">
                <h4 className="font-bold text-sm text-slate-900 dark:text-white mb-1.5">3. Digital Asset Risk Disclosure</h4>
                <p>
              ...
              <section className="p-3.5 rounded-xl bg-slate-50 dark:bg-white/[0.02] border border-slate-200 dark:border-white/[0.04]">
                <h4 className="font-bold text-sm text-slate-900 dark:text-white mb-1.5">4. Account Security & 2FA</h4>
                <p>
            ...
            <>
              <section className="p-3.5 rounded-xl bg-slate-50 dark:bg-white/[0.02] border border-slate-200 dark:border-white/[0.04]">
                <h4 className="font-bold text-sm text-slate-900 dark:text-white mb-1.5">1. Information We Collect</h4>
                <p>
              ...
              <section className="p-3.5 rounded-xl bg-slate-50 dark:bg-white/[0.02] border border-slate-200 dark:border-white/[0.04]">
                <h4 className="font-bold text-sm text-slate-900 dark:text-white mb-1.5">2. Data Encryption & Security</h4>
                <p>
              ...
              <section className="p-3.5 rounded-xl bg-slate-50 dark:bg-white/[0.02] border border-slate-200 dark:border-white/[0.04]">
                <h4 className="font-bold text-sm text-slate-900 dark:text-white mb-1.5">3. Your Data Rights</h4>
                <p>
        ...
        <div className="pt-4 mt-2 border-t border-slate-200 dark:border-white/[0.08] flex items-center justify-between">
