...
import { Home, BarChart2, ArrowLeftRight, Sparkles, Wallet } from 'lucide-react';
...
export const BottomNav: React.FC<BottomNavProps> = ({
  ...
  return (
    <nav
      ...
      className="fixed bottom-0 left-0 right-0 z-40 bg-[#090C14]/92 backdrop-blur-xl border-t border-white/[0.07] safe-area-bottom md:hidden"
    >
